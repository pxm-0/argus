#!/usr/bin/env python3
"""Shared helpers for Argus CLI scripts."""
...
RETIRED_OPERATOR_LINKS = {
    "argus-acceptance-summary": "argus-acceptance-summary",
    "argus-access-apply": "argus-access-apply",
    "argus-access-preview": "argus-access-preview",
    "argus-access-reconcile": "argus-access-reconcile",
    "argus-backup-plan": "argus-backup-plan",
    "argus-backup-prune": "argus-backup-prune",
    "argus-backup-run": "argus-backup-run",
    "argus-cloudflare-activate": "argus-cloudflare-activate",
    "argus-cloudflare-activate-preview": "argus-cloudflare-activate-preview",
    "argus-cloudflare-plan": "argus-cloudflare-plan",
    "argus-cloudflare-rollback": "argus-cloudflare-rollback",
    "argus-events": "argus-events",
    "argus-legacy-inventory": "argus-legacy-inventory",
    "argus-logs": "argus-logs",
    ...
    "argus-restore-plan": "argus-restore-plan",
    "argus-sandbox-firewall": "argus-sandbox-firewall",
    "argus-smoke-scheduled": "argus-smoke-scheduled",
    "argus-smoke-test": "smoke-test",
