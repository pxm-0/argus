...
.domain-group[data-domain-state="active"] .domain-state { background:var(--blue); box-shadow:0 0 9px rgba(104,167,255,.45); }
...
.matrix-empty small { margin-top:3px; color:#697891; }
