...
.workload-status { display:flex; align-items:center; justify-content:space-between; gap:12px; padding:12px 0; border-bottom:1px solid var(--line); }
...
.workload-context { display:flex; flex-wrap:wrap; justify-content:flex-end; gap:6px 14px; color:var(--muted); font-size:11px; }.workload-context span { white-space:nowrap; }.workload-context strong { color:var(--ink); font-weight:700; }
...
.monitor,.command-panel { margin-top:18px;padding:16px;border:1px solid var(--line);background:var(--field); }.command-panel { border-color:color-mix(in srgb,var(--blue) 48%,var(--line)); }.command-header { display:flex; align-items:flex-start; justify-content:space-between; gap:16px; }.command-heading { display:flex; align-items:center; gap:12px; min-width:0; }.command-heading h2 { margin-top:3px; font-size:20px; text-transform:none; overflow-wrap:anywhere; }.result-badge { flex:0 0 auto; padding:5px 8px; border:1px solid currentColor; border-radius:999px; font-size:10px; font-weight:800; letter-spacing:.08em; text-transform:uppercase; }.result-badge.info { color:var(--blue); }.result-badge.good { color:var(--blue); }.result-badge.warn { color:var(--gold); }.result-badge.bad { color:var(--red); }.command-summary { max-width:80ch; margin-top:14px; color:var(--ink); font-size:15px; text-wrap:pretty; }.command-highlights { display:grid; grid-template-columns:repeat(auto-fit,minmax(150px,1fr)); margin:14px 0 0; border-top:1px solid var(--line); border-left:1px solid var(--line); }.command-highlights div { min-width:0; padding:9px 10px; border-right:1px solid var(--line); border-bottom:1px solid var(--line); }.command-highlights dd { margin:3px 0 0; overflow-wrap:anywhere; font-weight:700; }.command-details { margin-top:12px; }.command-details summary { display:flex; justify-content:space-between; gap:12px; padding:9px 0; border-bottom:1px solid var(--line); color:var(--muted); font-weight:700; cursor:pointer; }.command-details summary span { font-size:10px; font-weight:400; letter-spacing:.08em; text-transform:uppercase; }.command-details pre { margin:0; padding:12px; max-height:280px; background:var(--void); color:var(--muted); }.command-actions { margin-top:12px; }.metrics-grid,.plan-grid { display:grid;grid-template-columns:repeat(4,1fr);border-left:1px solid var(--line);border-top:1px solid var(--line); }.metric,.plan-grid article { padding:14px;border-right:1px solid var(--line);border-bottom:1px solid var(--line);background:var(--field); }.metric p { margin-top:5px;font-size:20px;color:var(--blue);font-variant-numeric:tabular-nums; }.bar { height:3px;margin-top:8px;background:var(--line); }.bar span { display:block;height:100%;background:var(--blue); }.plan-grid { margin-top:18px;grid-template-columns:repeat(5,1fr); }.plan-grid article p { margin:8px 0;color:var(--muted); }pre { max-height:220px;overflow:auto;white-space:pre-wrap;font:12px/1.45 ui-monospace,SFMono-Regular,Menlo,Consolas,monospace; }
