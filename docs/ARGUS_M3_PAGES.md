...
Configure the repository Actions secret ARGUS_PORTFOLIO_SIGNING_KEY with an
Ed25519 private key before enabling deployment. It is never committed or
printed. The workflow builds and verifies the signed artifact, records a
